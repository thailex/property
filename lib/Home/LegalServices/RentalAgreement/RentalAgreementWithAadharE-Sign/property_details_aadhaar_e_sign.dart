...
class PropertyDetailsAadhaarESign extends StatefulWidget {
  const PropertyDetailsAadhaarESign({super.key});

  @override
  State<PropertyDetailsAadhaarESign> createState() =>
      _PropertyDetailsAadhaarESignState();
}

class _PropertyDetailsAadhaarESignState
    extends State<PropertyDetailsAadhaarESign> {
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const LandLordDetailEStamp(), // Replace with your next screen
                  ),
                );
              },
              child: Container(
