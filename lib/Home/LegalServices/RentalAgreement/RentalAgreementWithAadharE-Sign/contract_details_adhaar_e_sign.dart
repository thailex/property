...
import 'package:prides_sales_and_lettings/Home/LegalServices/RentalAgreement/RentalAgreementWithAadharE-Sign/property_details_aadhaar_e_sign.dart';
import 'package:prides_sales_and_lettings/Home/LegalServices/RentalAgreement/RetalAgreementEStamp/property_details_e_stamp.dart';

class AadhaarESignContract extends StatefulWidget {
  const AadhaarESignContract({super.key});

  @override
  State<AadhaarESignContract> createState() => _AadhaarESignContractState();
}

class _AadhaarESignContractState extends State<AadhaarESignContract> {
  bool isSave = false;
              ...
              onTap: () {
                setState(() {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const PropertyDetailsAadhaarESign()),
                  );
                });
              },
              child: Container(
  ...
  bool areFieldsValid() {
    return isRefundableDepositAmount &&
        is500Stamp &&
        is100Stamp &&
        is6Month &&
        is11Month &&
