...
import 'package:prides_sales_and_lettings/Home/LegalServices/RentalAgreement/RentalAgreementWithAadharE-Sign/tenant_details_aadhaar_e_sign.dart';
import 'package:prides_sales_and_lettings/Home/LegalServices/RentalAgreement/RetalAgreementEStamp/tenant_details.dart';

class LandlordDetailsAadhaarESign extends StatefulWidget {
  const LandlordDetailsAadhaarESign({super.key});

  @override
  State<LandlordDetailsAadhaarESign> createState() =>
      _LandlordDetailsAadhaarESignState();
}

class _LandlordDetailsAadhaarESignState
    extends State<LandlordDetailsAadhaarESign> {
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const TenantDetailsAadhaarESign(), // Replace with your next screen
                  ),
                );
              },
              child: Container(
