...
class TenantDetailEStamp extends StatefulWidget {
  const TenantDetailEStamp({super.key});

  @override
  State<TenantDetailEStamp> createState() => _TenantDetailEStampState();
}

class _TenantDetailEStampState extends State<TenantDetailEStamp> {
