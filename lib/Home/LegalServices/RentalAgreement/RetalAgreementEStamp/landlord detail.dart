...
class LandLordDetailEStamp extends StatefulWidget {
  const LandLordDetailEStamp({super.key});

  @override
  State<LandLordDetailEStamp> createState() => _LandLordDetailEStampState();
}

class _LandLordDetailEStampState extends State<LandLordDetailEStamp> {
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const TenantDetailEStamp(), // Replace with your next screen
                  ),
                );
              },
              child: Container(
