...
class StampContract extends StatefulWidget {
  const StampContract({super.key});

  @override
  State<StampContract> createState() => _StampContractState();
}

class _StampContractState extends State<StampContract> {
  bool isSave = false;
              ...
              onTap: () {
                setState(() {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const PropertyDetailsEStamp()),
                  );
                });
              },
              child: Container(
