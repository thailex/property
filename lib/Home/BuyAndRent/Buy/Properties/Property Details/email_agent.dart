...
class EmailAgent extends StatefulWidget {
  const EmailAgent({super.key});

  @override
  State<EmailAgent> createState() => _EmailAgentState();
}

class _EmailAgentState extends State<EmailAgent> {
