...
import 'package:prides_sales_and_lettings/Home/BuyAndRent/Buy/Properties/Property%20Details/propertydetails_buy.dart';
import '../../../../../Colors/colors.dart';

class PropertiesBuy extends StatefulWidget {
  const PropertiesBuy({super.key});

  @override
  State<PropertiesBuy> createState() => _PropertiesBuyState();
}

class _PropertiesBuyState extends State<PropertiesBuy> {
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const PropertyDetailsBuy(),
                    ),
                  );
                },
                child: SizedBox(
