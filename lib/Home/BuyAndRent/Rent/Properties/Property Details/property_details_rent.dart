...
class PropertyDetailsRent extends StatefulWidget {
  const PropertyDetailsRent({super.key});

  @override
  State<PropertyDetailsRent> createState() => _PropertyDetailsRentState();
}

class _PropertyDetailsRentState extends State<PropertyDetailsRent>
